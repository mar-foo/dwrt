...
START_TEST(test_readall_short)
{
	...
	f = fopen("files/test_readall_short.txt", "r");
	ck_assert(f != NULL);
...
START_TEST(test_readall_long)
{
	...
	f = fopen("files/test_readall_long.txt", "r");
	ck_assert(f != NULL);

	buf = readall(f);
	ck_assert_str_eq(buf, "\n");
	free(buf);
}
END_TEST
